...
set crc32 [::crc::crc32 -file output_files/afe.rbf]
...
::tar::create "fw_llrf_afe_${maj}_${min}_${hash}.tar" manifest.txt
::tar::add "fw_llrf_afe_${maj}_${min}_${hash}.tar" afe.rbf
