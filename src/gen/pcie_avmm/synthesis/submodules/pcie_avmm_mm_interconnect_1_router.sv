...
module pcie_avmm_mm_interconnect_1_router_default_decode
  #(
...
module pcie_avmm_mm_interconnect_1_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    pcie_avmm_mm_interconnect_1_router_default_decode the_default_decode(
